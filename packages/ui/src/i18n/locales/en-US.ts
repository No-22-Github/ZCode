...
const enUS: Record<string, string> = {
  ...
  "serverStats.online": "Connected",
  "serverStats.offline": "Offline · updated {seconds}s ago",
  "serverStats.disconnected": "Disconnected",
  "serverStats.uptime": "Uptime",
  "serverStats.pin": "Pin panel",
  "serverStats.collapse": "Collapse panel",
  "serverStats.cpuChart": "CPU history, fixed 0–100% scale",
  "serverStats.networkChart":
    "Network history, download above and upload below, shared linear scale",
  "serverStats.load": "Load",
  "serverStats.peak": "Peak",
  "serverStats.used": "Used",
  "serverStats.cache": "Cache (separate metric)",
  "serverStats.process": "Server RSS",
  "serverStats.network": "Network",
  "serverStats.today": "Observed today (UTC)",
  "serverStats.trafficSince": "Counted since {time} UTC; gaps excluded",
  "serverStats.disk": "Disk",
  "serverStats.hostIo": "Host disk I/O read/write",
  "serverStats.range": "History range",
  "serverStats.1m": "1 min",
  "serverStats.15m": "15 min",
  "serverStats.24h": "24 h",
  "serverStats.resolution": "{seconds}s / point",
  "serverStats.shape": "Collapsed view",
  "serverStats.ball": "Dual-ring ball",
  "serverStats.capsule": "Capsule",
  "serverStats.mini": "Mini capsule",
  "serverStats.historySince": "History since {time} UTC; resets on restart",
  "serverStats.cpu": "CPU",
