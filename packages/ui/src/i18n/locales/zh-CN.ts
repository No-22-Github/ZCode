...
const zhCN: Record<string, string> = {
  ...
  "serverStats.online": "已连接",
  "serverStats.offline": "断连 · {seconds}s 前更新",
  "serverStats.disconnected": "已断连",
  "serverStats.uptime": "运行",
  "serverStats.pin": "固定面板",
  "serverStats.collapse": "收起面板",
  "serverStats.cpuChart": "CPU 使用率历史，固定 0–100%",
  "serverStats.networkChart": "网络历史，上方下行，下方上行，共用线性刻度",
  "serverStats.load": "负载",
  "serverStats.peak": "峰值",
  "serverStats.used": "已用",
  "serverStats.cache": "缓存（独立统计）",
  "serverStats.process": "服务进程 RSS",
  "serverStats.network": "网络",
  "serverStats.today": "今日已观测（UTC）",
  "serverStats.trafficSince": "从 {time} UTC 开始累计，缺测不计入",
  "serverStats.disk": "磁盘",
  "serverStats.hostIo": "主机磁盘 I/O 读/写",
  "serverStats.range": "历史范围",
  "serverStats.1m": "1 分钟",
  "serverStats.15m": "15 分钟",
  "serverStats.24h": "24 小时",
  "serverStats.resolution": "{seconds}s / 点",
  "serverStats.shape": "收起形态",
  "serverStats.ball": "双环球",
  "serverStats.capsule": "胶囊",
  "serverStats.mini": "迷你胶囊",
  "serverStats.historySince": "历史始于 {time} UTC；重启后重新积累",
  "serverStats.cpu": "CPU",
